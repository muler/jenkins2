...
@SpringBootTest(classes = SampleProjectApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext
public class SampleProjectApplicationTests {

	private static Log logger = LogFactory.getLog(SampleProjectApplicationTests.class);
